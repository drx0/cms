...
$path = [
    'layouts'=>ROOT.'/contents/theme/layouts',
    'pages'=>ROOT.'/contents/theme/pages',
    'partials'=>ROOT.'/contents/theme/partials',
    'views'=>ROOT.'/contents/theme/views',
    'assets'=>ROOT.'/contents/theme/assets',
    'assets_url'=>$domain.'/contents/theme/assets'
];
...
// settings
$settings = FDB_Get('frontend/settings', true);
if(!is_array($settings)){
    echo 'БД: Ошибка, файл (frontend/settings) поврежден.';
    die;
}
